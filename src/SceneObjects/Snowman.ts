...
/**
 * Creates a snowman scene object
 *
...
function createSnowman() {
	...
	topCoalBut.material.setProperty("u_color", [0, 0, 0, 1]);
	...
	coalRightEye.material.setProperty("u_color", [0, 0, 0, 1]);
